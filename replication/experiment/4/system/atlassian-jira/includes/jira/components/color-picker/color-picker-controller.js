define('jira/components/color-picker/color-picker-controller', ['marionette-3.1', 'backbone', 'jira/components/color-picker/view/color-picker-view', 'jira/components/color-picker/sample-color/sample-colors-factory'], function (Marionette, Backbone, ColorPickerView, sampleColorsFactory) {
    "use strict";
