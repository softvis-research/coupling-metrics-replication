----------------------------------------------
JIRA 7.7.1-#77002 README
----------------------------------------------

Thank you for downloading JIRA 7.7.1. This distribution comes with a
...
2. Set the JAVA_HOME variable to where you installed Java. The Windows
   ...
   http://docs.atlassian.com/jira/jadm-docs-077/Installing+Java

3. Set your JIRA Home Directory.
   Instructions on how to set your JIRA Home Directory can be found here:

   http://docs.atlassian.com/jira/jadm-docs-077/Setting+your+JIRA+application+home+directory
...
http://docs.atlassian.com/jira/jadm-docs-077/Installing+JIRA+applications
...
http://docs.atlassian.com/jira/jadm-docs-077/
